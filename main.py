...
class MyServer(BaseHTTPRequestHandler):
    ...
    def __get_html_content(self):
        """
        возвращает код для работы сайта
        :return: html код для работы сайта
        """
        return """
        <!doctype html>
<html lang="en">
            ...
            <div class="row">
                <div class="col">
                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                        <div class="card card-body">
                            купить в магазине все по 100$ искать в разделе электронники в отделе компьютеров и
                ...
                <div class="col">
                    <div class="collapse multi-collapse" id="multiCollapseExample2">
                        <div class="card card-body">
                            доставка осуществляется ежедневно в выбраное вами время , указать время и адрес можно после
                            покупки.
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="collapse multi-collapse" id="multiCollapseExample3">
                        <div class="card card-body">
                            гарантия в течении года после покупки .
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    def do_GET(self):
        ...
        self.wfile.write(bytes(page_content, "utf-8"))  # Тело ответа self.__get_index()
